...
/* harmony import */ var _components_form_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/form.js */ "./src/js/components/form.js");
/* harmony import */ var _components_renderCard_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/renderCard.js */ "./src/js/components/renderCard.js");
/* harmony import */ var _components_renderModals_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/renderModals.js */ "./src/js/components/renderModals.js");
...
/* harmony import */ var _components_scrollTarget_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/scrollTarget.js */ "./src/js/components/scrollTarget.js");
...
/* harmony import */ var _components_popper_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/popper.js */ "./src/js/components/popper.js");
...
buttons.forEach(button => {
  ...
  if (targetElement) {
    if (!sectionButtonMap.has(targetElement)) {
      sectionButtonMap.set(targetElement, []);
    }
    sectionButtonMap.get(targetElement).push(button);
  }
});
...
const observer = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    if (entry.isIntersecting) {
      ...
      const activeButtons = sectionButtonMap.get(entry.target);
      if (activeButtons) {
        activeButtons.forEach(button => button.classList.add('is-active'));
      }
    }
  });
}, {
...
buttons.forEach(button => {
  button.addEventListener('click', event => {
    ...
    if (targetElement) {
      ...
      const activeButtons = sectionButtonMap.get(targetElement);
      if (activeButtons) {
